...
<br>
 ...
 <br>
 <br>
  <form action="${pageContext.request.contextPath}/user/Userregister" id="form1" method="post">
    <div class="form-group">
      <label for="name">用户名:</label>
      <input type="text" class="form-control" id="uname" name="uname" placeholder="请输入要注册用户名">
    </div>
    <div class="form-group">
